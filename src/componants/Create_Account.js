    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: "center", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: '50px', }}>
          <div onClick={() => changepage("signin")} style={{ cursor: "pointer" }}>
        ...
        <form onSubmit={handleLogin} >
          ...
          {/* <div className="item-title item-label" style={{ margin: "20px 0px", fontSize: '14px', color: '#8a8a8a', fontWeight: '400' }}>ชื่อผู้ใช้</div> */}
          ...
          {/* <div className="item-title item-label" style={{ margin: "20px 0px", fontSize: '14px', color: '#8a8a8a', fontWeight: '400' }}>อีเมล</div> */}
          <div style={{ display: 'flex', flexDirection: "column", justifyContent: 'center', alignItems: 'center', fontSize: '14px', marginTop: "20px" }}>
            <div className="form-group" style={{ width: "100%" }}>
          ...
          {/* <div className="item-title item-label" style={{ margin: "20px 0px", fontSize: '14px', color: '#8a8a8a', fontWeight: '400' }}>รหัสผ่าน</div> */}
          <div style={{ display: 'flex', flexDirection: "column", justifyContent: 'center', alignItems: 'center', fontSize: '14px', marginTop: "20px" }}>
            <div className="form-group" style={{ width: "100%" }}>
            ...
            <Button style={{
              ...
              borderRadius: '50px', padding: '18px 25px', height: '56.8px', color: '#ffffff', fontWeight: '600',
          ...
          <div style={{
            ...
            <p className="form-text" >การกดปุ่มสมัครแสดงว่าคุณยอมรับ
              <a href="#" style={{
