    ...
    return (
        <div style={{
            ...
            <p style={{
                ...
                fontWeight: '400', height: "100%", color: '#777777'
            }}>Coffee Shop App</p>
            <h2 style={{
                marginTop: '2px', marginBottom: '70px', fontSize: '24px',
                fontWeight: '600', lineHeight: '1.3', textAlign: 'center', color: '#1b1b1b'
            }}>Morning begins with Ombe coffee</h2>
