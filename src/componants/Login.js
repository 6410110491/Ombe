...
function Login() {
    return (
        <div style={{
            height: "100%", display: "flex", alignItems: "center", justifyContent: "center",paddingTop: '80px',
            ...
            <h2 style={{margin:'17.5px 0 0' , fontSize: '38px', fontWeight: '600'}}>Ombe</h2>
            <p style={{margin:'13.5px 0 0' , marginBottom:'50px' , fontSize: '14px', 
            fontWeight: '400',height: "100%",color: '#777777'}}>Coffee Shop App</p>
            <h2 style={{marginTop:'2px', marginBottom:'70px', fontSize: '24px', 
            fontWeight: '600', lineHeight: '1.3',textAlign: 'center' , color: '#1b1b1b'}}>Morning begins with Ombe coffee</h2>
            ...
            <div style={{width: '100%',  boxSizing: 'border-box'}}>
                <div style={{
                    ...
                    <div style={{ fontWeight: "600", color: "#FFFFFF" }}>Login With Email</div>
                    <div></div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{ fontWeight: "600", color: "#FFFFFF" }}>Login With Facebook</div>
                    <div></div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{ fontWeight: "600", color: "#03764D" }}>Login With Google</div>
                    <div></div>
                </div>
            </div>
        </div>
