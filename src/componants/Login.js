...
function Login() {
    return (
        <div style={{
            ...
            padding: "1.5rem", flexDirection: "column"
        }}>
            ...
            <div style={{width: '60%'}}>
                <div style={{
                    ...
                    width: "100%", display: 'flex', justifyContent: "space-between", alignItems: 'center', padding: "18px 25px",
                    cursor: "pointer", fontSize: '16px'
                }}>
                    <div><FontAwesomeIcon icon={faEnvelope} style={{ marginRight: '10px' }} /></div>
                    <div style={{ fontWeight: "bold", color: "#FFFFFF" }}>Login With Email</div>
                    <div></div>
                </div>
                ...
                <div style={{
                    ...
                    <div><FontAwesomeIcon icon={faFacebook} style={{ marginRight: '10px' }} /></div>
                    <div style={{ fontWeight: "bold", color: "#FFFFFF" }}>Login With Facebook</div>
                    <div></div>
                </div>

                <div style={{
                    marginTop: '15px', backgroundColor: "#FFFFFF", border: "1px solid grey",
                    borderRadius: '50px', padding: '18px 25px', height: 'auto', color: '#03764D', fontWeight: 'bold',
                    width: "100%", display: 'flex', justifyContent: "space-between", alignItems: 'center', padding: "18px 25px",
                    cursor: "pointer", fontSize: '16px'
                }}>
                    ...
                    <div style={{ fontWeight: "bold", color: "#03764D" }}>Login With Google</div>
                    <div></div>
                </div>
            </div>
        </div>
