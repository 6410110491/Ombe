        ...
        <div style={{
            ...
            <div >
                ...
                <form onSubmit={handleLogin} >
                    <h2 style={{ textAlign: 'left', fontSize: '1.5rem', marginBottom: '10px', fontWeight: '600' }}>Sign In</h2>
                    <p className="subtext" style={{ fontSize: '14px' }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>

                    <div class="item-title item-label" style={{marginTop: "30px" , fontSize: '14px', color: '#8a8a8a'}}>Username</div>
                    ...
                    <div class="item-title item-label" style={{marginTop: "30px" , fontSize: '14px' , color: '#8a8a8a'}}>Password</div>
                    <div style={{ display: 'flex', flexDirection: "column", justifyContent: 'center', alignItems: 'center', fontSize: '14px' }}>
                        <div className="form-group" style={{ width: "100%" }}>
                ...
                <div className="mt-4" style={{ display: "flex", flexDirection: "column", justifyContent: 'center', alignItems: 'center' }}>
                    <p className="mb-0  text-center" style={{ fontSize: '14px', marginBottom: '14px', textAlign: 'center', fontWeight: '500', opacity: '0.4' }}>
                        Don't have an account?{" "}
                    </p>
                    <Button style={{
                        marginTop: '1rem', backgroundColor: "#F7DBB4", border: 'none', borderRadius: '50px', 
                        padding: '18px 25px', height: 'auto', color: '#5B5046', fontWeight: 'bold', width: "100%", fontSize: '16px'
                    }}>
                        CREATE AN ACCOUNT
                    </Button>
                </div>
